document.addEventListener('DOMContentLoaded', () => {
    ...
    function getWindDirectionIcon(wind_deg) {
        const directions = [
            ...
            { min: 191.25, max: 213.75, icon: 'icons/wind/ssw.png' },
            { min: 213.75, max: 236.25, icon: 'icons/wind/sw.png' },
            { min: 236.25, max: 258.75, icon: 'icons/wind/wsw.png' },
            { min: 258.75, max: 281.25, icon: 'icons/wind/w.png' },
            { min: 281.25, max: 303.75, icon: 'icons/wind/wnw.png' },
            { min: 303.75, max: 326.25, icon: 'icons/wind/nw.png' },
            { min: 326.25, max: 348.75, icon: 'icons/wind/nnw.png' }
        ];
